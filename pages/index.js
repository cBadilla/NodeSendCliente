        ...
        {url ? (
          <Fragment>
            <p className="text-center text-2xl mt-10">
              <span className="font-bold text-red-700 text-3xl uppercase">La URL del archivo es: </span>{`${process.env.frontEndURL}/enlaces/${url}`}</p>

            <button
              type="button"
              className="bg-red-500 hover:bg-gray-900 rounded w-full p-2 text-white uppercase font-bold mt-10"
